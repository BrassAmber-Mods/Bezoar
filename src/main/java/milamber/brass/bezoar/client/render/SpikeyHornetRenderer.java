...
public class SpikeyHornetRenderer<Type extends AbstractGiantHornetEntity> extends MobRenderer<Type, GiantHornetModel<Type>> {

    public static final ResourceLocation TEXTURE = new ResourceLocation(Bezoar.MOD_ID, "textures/entity/spikey_hornet.png");

    public SpikeyHornetRenderer(EntityRendererProvider.Context context) {
        super(context,
