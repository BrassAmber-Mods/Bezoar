...
public class HoneyHornetRenderer<Type extends AbstractGiantHornetEntity> extends MobRenderer<Type, GiantHornetModel<Type>> {

    public static final ResourceLocation TEXTURE = new ResourceLocation(Bezoar.MOD_ID, "textures/entity/honey_hornet.png");

    public HoneyHornetRenderer(EntityRendererProvider.Context context) {
        super(context,
