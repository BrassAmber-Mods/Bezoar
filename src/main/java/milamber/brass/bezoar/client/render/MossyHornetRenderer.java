...
public class MossyHornetRenderer<Type extends AbstractGiantHornetEntity> extends MobRenderer<Type, GiantHornetModel<Type>> {

    public static final ResourceLocation TEXTURE = new ResourceLocation(Bezoar.MOD_ID, "textures/entity/mossy_hornet.png");

    public MossyHornetRenderer(EntityRendererProvider.Context context) {
        super(context,
