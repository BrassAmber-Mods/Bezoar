...
public class Floral_Hornet_Renderer extends MobRenderer<Giant_Hornet, Giant_Hornet_Model<Giant_Hornet>> {

    public static final ResourceLocation TEXTURE = new ResourceLocation(BezoarMod.MOD_ID, "textures/entity/floral_hornet.png");

    public Floral_Hornet_Renderer(EntityRendererManager manager) {
