...
public class Delta_Hornet_Renderer extends MobRenderer<Giant_Hornet, Giant_Hornet_Model<Giant_Hornet>> {

    public static final ResourceLocation TEXTURE = new ResourceLocation(BezoarMod.MOD_ID, "textures/entity/delta_hornet.png");

    public Delta_Hornet_Renderer(EntityRendererManager manager) {
