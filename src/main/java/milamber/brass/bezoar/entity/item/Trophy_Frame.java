...
public class Trophy_Frame extends HangingEntity {
    ...
    public Trophy_Frame(EntityType<? extends Trophy_Frame> p_i50224_1_, World world) {
        super(p_i50224_1_, world);
    }

    public Trophy_Frame(World worldIn, BlockPos pos, Direction facing) {
