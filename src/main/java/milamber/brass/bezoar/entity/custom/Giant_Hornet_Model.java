package milamber.brass.bezoar.entity.custom;// Made with Blockbench 4.0.3
...
public class Giant_Hornet_Model<Type extends Giant_Hornet> extends EntityModel<Type> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static ModelLayerLocation LAYER_LOCATION;
	private final ModelPart hornet;

	public Giant_Hornet_Model(ModelPart root, ModelLayerLocation location) {
