...
public class GiantTortoiseEntity extends Animal implements NeutralMob {
    ...
    private static final ResourceLocation LOOT_TABLE = new ResourceLocation(Bezoar.MOD_ID, "entities/giant_tortoise");

    public GiantTortoiseEntity(EntityType<? extends Animal> p_27557_, Level p_27558_) {
